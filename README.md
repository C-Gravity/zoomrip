...
⚠️ **Важно!** Разработчики Zoom [запретили вход в конференции без авторизации](https://github.com/crinny/zoomrip/issues/22). Утилита времмено (или навсегда) не работает.
